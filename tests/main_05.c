...
void TIM3_IRQHandler(void) {
	...
	current_num = (current_num < 4) ? ++current_num : 0;
	TIM3->SR &= ~TIM_SR_UIF;	
}
...
void GPIO_Config(void) {
	...
	RCC->AHB1ENR |= RCC_AHB1ENR_GPIODEN | RCC_AHB1ENR_GPIOEEN; // enables GPIOD peripheral clock    
        ...
        GPIOE->MODER |= GPIO_MODER_MODE0_0 | GPIO_MODER_MODE1_0 | 
			GPIO_MODER_MODE2_0 | GPIO_MODER_MODE3_0 | GPIO_MODER_MODE4_0; // alternative function mode
